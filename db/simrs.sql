...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 19, 2025 at 05:05 AM
...
CREATE TABLE `pemeriksaan` (
  ...
  `durasi_pemeriksaan` int(11) DEFAULT NULL,
  `created_at` timestamp NOT NULL DEFAULT current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(1, '3213134123', 'sfsfss', 'swwew', '2025-12-19', 'L', '21312312', 'rqweqe', '2025-12-18', 'Poli Gigi', '', '', '2025-12-18 11:09:52');
...
--
ALTER TABLE `pemeriksaan`
  ADD CONSTRAINT `pemeriksaan_ibfk_1` FOREIGN KEY (`id_antrian`) REFERENCES `antrian` (`id`) ON DELETE CASCADE;
COMMIT;
